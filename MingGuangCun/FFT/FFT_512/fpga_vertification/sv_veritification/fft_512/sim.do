...
vlog     $WORK_HOME/bram_ctrl.v
vlog     $WORK_HOME/TF.v
vlog     $WORK_HOME/fft_8.v
vlog     $WORK_HOME/rotator_factor_512.v
vlog     $WORK_HOME/fft_top.v
vlog     $WORK_HOME/fft_512.v
vlog     $WORK_HOME/fft_512_tb.sv

vsim  -c -sv_lib $UVM_DPI_HOME/uvm_dpi   work.fft_512_tb
run 100